...
public class Automovel implements Comparable<Automovel> {
	...
	//1.criando um método construtor (construtores)
	//deve ser criado dentro da classe, com o mesmo nome do método
	
	//2.mudar o contrutor para exigir a marca para criar o objeto
